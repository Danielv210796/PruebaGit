...
namespace PruebaGit.Web.Controllers
{
    public class AdministradorsController : Controller
    {
        ...
        {
            var administradors = db.Administradors.Include(a => a.Trabajador);
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Trabajador = db.Trabajadors.ToList(); //select*from trabajadores
            ViewBag.TrabajadorId = new SelectList(db.Trabajadors, "Id", "Nombre");
            return View();
        }
        ...
        public ActionResult Create(Administrador administrador)
        {
            ...
            ViewBag.TrabajadorId = new SelectList(db.Trabajadors, "Id", "Nombre", administrador.TrabajadorId);
            return View(administrador);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Id_Usuario,Nombre,APM,APP,TrabajadorId")] Administrador administrador)
        {
            if (ModelState.IsValid)
            {
